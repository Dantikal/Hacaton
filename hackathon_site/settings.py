...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-7qp=l*d-=vg0_wdm5-exl61pij^@t#d$331%7_ps0#jx#no^!v')
...
INSTALLED_APPS = [
    ...
    'whitenoise.runserver_nostatic',  # ДОБАВЬТЕ
    'accounts',
    'teams',
    'news',
    'chat',
...
MIDDLEWARE = [
    ...
    'whitenoise.middleware.WhiteNoiseMiddleware',  # ДОБАВЬТЕ ПЕРВЫМ!
...
# ВСЕГДА определяем STATIC_ROOT и STATICFILES_DIRS
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')  # ← ВАЖНО! УБИРАЕМ из условия
